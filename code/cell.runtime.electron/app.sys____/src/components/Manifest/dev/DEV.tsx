...
import { t, IpcBus, Bundle } from './common';

const manifest = require('./sample/manifest.json') as t.BundleManifest; // eslint-disable-line
...
export const actions = DevActions<Ctx>()
  ...
  .context((e) => {
    ...
    return { netbus, events, props: { manifest } };
  })
