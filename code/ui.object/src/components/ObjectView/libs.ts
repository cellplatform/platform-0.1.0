...
export const CHROME_LIGHT = require('react-inspector/lib/styles/themes/chromeLight.js');
export const CHROME_DARK = require('react-inspector/lib/styles/themes/chromeDark.js');
