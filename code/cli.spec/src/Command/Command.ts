...
type ICommandArgs<P extends object = any, A extends t.CommandArgsOptions = any> = {
  name: string;
  description: string;
 ...
 */
export class Command<P extends object = any, A extends t.CommandArgsOptions = any>
   ...
   */
  public static create<P extends object = any, A extends t.CommandArgsOptions = any>(
    title: string,
