...
import { css, CssValue, defaultValue, PeerNetwork, t } from '../DEV.common';
import {
  DevConnection,
  DevConnections,
  DevDataConnections,
...
import { NetbusCard } from '../DEV.event';
...
export const DevNetworkConnections: React.FC<DevNetworkConnectionsProps> = (props) => {
  ...
  const elNetbus = props.showNetbus && (
    <NetbusCard netbus={netbus} margin={[PADDING.CARD, 0, 0, PADDING.CARD]} />
  );
