...
export const DEFS: TypeDefs = {
  [NS.TYPE.APP]: {
    columns: {
      ...
      B: {
        props: {
          def: { prop: 'CellApp.windowDefs', type: `${NS.TYPE.WINDOW_DEF}/CellAppWindowDef[]`, target: 'ref' },
        },
      },
      C: {
        props: { def: { prop: 'CellApp.windows', type: `${NS.TYPE.WINDOW}/CellAppWindow[]`, target: 'ref' } },
      },
    },
  },
  [NS.TYPE.WINDOW_DEF]: {
