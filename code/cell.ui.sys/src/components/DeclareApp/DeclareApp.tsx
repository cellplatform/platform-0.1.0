...
export type IDeclareAppProps = { env: t.IEnv; style?: CssValue };
export type IDeclareAppState = {
  isDragOver?: boolean;
  files?: FileItem[];
  image?: FileItem;
};
...
export class DeclareApp extends React.PureComponent<IDeclareAppProps, IDeclareAppState> {
  public state: IDeclareAppState = {};
  private state$ = new Subject<Partial<IDeclareAppState>>();
  private unmounted$ = new Subject<{}>();

  /**
   * [Lifecycle]
   */
  constructor(props: IDeclareAppProps) {
    super(props);
  }
  ...
  public async loadFiles() {
    const client = Client.http(this.props.env.host);
