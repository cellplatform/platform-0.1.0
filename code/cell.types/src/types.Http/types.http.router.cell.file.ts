...
export type IReqQueryCellFilesDelete = Record<string, undefined>; // 🐷 Placeholder type.
 ...
 */
export type IReqPostCellFilesUploadCompleteBody = Record<string, undefined>; // 🐷 Placeholder type.
