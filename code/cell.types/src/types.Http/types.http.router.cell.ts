...
export type IReqQueryCellInfo = Record<string, undefined>; // 🐷 Placeholder type.
...
export type IReqQueryRowInfo = Record<string, undefined>; // 🐷 Placeholder type.
...
export type IReqQueryColumnInfo = Record<string, undefined>; // 🐷 Placeholder type.
